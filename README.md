...
### Quick Start by Toptive
You need to create and configure a `.env` file. The project is prepared to use mysql. So you should have mysql on your environment create the database and run a sql script: `react-training-base/db/mysql-schema.sql` 
To run the project: `npm i` and `npm run dev`.
